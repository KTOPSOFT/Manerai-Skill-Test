// Derived from Unity built-in shader source. Copyright (c) 2016 Unity Technologies. MIT license (see license.txt)
// Modified to bypass depth testing so that particle is always visible (ZTest Always).

Shader "Particles/Custom Unlit"
{
    Properties
    {
