	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float3 gammaToLinear2 = GammaToLinearSpace( tex2D( _Texture, uv_Texture ).rgb );
				
				
				finalColor = float4( gammaToLinear2 , 0.0 );
				return finalColor;
			}
			ENDCG
		}
